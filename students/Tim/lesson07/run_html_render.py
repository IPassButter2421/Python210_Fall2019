...
header=Head(Meta("UTF-8"))\
.append(Title("PythonClass = Revision 1087"))

#body=Body(H(2,"PythonClass - Class 6 example"))
#body.append(P("a very small paragraph\nis this"))
#body.append(P("another small paragraph"))
#body.append(HR())

#If append returns self, I can now telescope, in fact write the whole file in one "functional" LISP-like expression



listing=Ul(Li("The first item in a list"),**{'id':"TheList", 'style':"line-height:200%"})\
.append(Li("This is the second item",style="color: red"))\
.append(Li('And this is a')\
.append(A("http://google.com",'link'))\
.append('To Google'))


body=Body(H(2,"PythonClass - Class 6 example"))\
.append(P("a very small paragraph\nis this", style="text-align: center",id="intro"))\
.append(P("another small paragraph")).append(HR()).append(listing)

File=Html().append(header).append(body)